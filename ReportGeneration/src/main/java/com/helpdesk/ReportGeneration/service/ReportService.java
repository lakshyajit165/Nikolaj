...
public class ReportService implements ReportInterface {
    ...
    public List<Report> getReports(int page, int limit) {
        System.out.println("we are on page number " + page);
        System.out.println("the limit of the page is " + limit);
    ...
    public Report getReportById(String id) {
        System.out.println("okay lets seeeeeE" + reportDao.findByTicketId(id));
        return reportDao.findByTicketId(id);
    }


    public List<com.helpdesk.ReportGeneration.entity.Service> getDataforService() {
        List<Report> reports = new ArrayList<>();
        System.out.println("I also want to know- " + reportDao);
        reports = reportDao.findAll();
        System.out.println("i want to know" + reports);
    ...
    public List<com.helpdesk.ReportGeneration.entity.Service> getDataforService(String startDate, String endDate) throws ParseException {
        ...
        List<Report> reports = new ArrayList<>();
        System.out.println("yha ni aana chahiye tha!!!");
    ...
    public List<Report> getReportsByStatus(String status, int page, int limit) {
        ...
        System.out.println("okay its coming in the service too");
        List<Report> reports = new ArrayList<>();
